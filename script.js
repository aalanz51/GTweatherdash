function pageData() {
    ...
    const APIKey = "0a4e719c2b7e9ca032a925a6c260cecd";
...
function getWeather(cityName) {
    ...
    const historyItem = document.createElement("input");
        ...
        historyItem.setAttribute("class", "form-control d-block bg-transparent text-white");
        historyItem.style.textAlign = 'right';
